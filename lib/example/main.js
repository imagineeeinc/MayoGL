import './style.css'
import '../lib.js'
import { MayoGL } from '../lib.js'

var disp = new MayoGL(document.getElementById("screen"),{width: window.innerWidth, height: window.innerHeight, alpha: true, clearColor: '#222', pixelSize: 2, antiAlias: true})
